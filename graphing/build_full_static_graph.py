...
output_file = GRAPHING_DIR / "output" / "pathway_graph_full_static.png"
...
print("Computing layout (this takes time for large graphs)...")

# 使用 spring_layout，但限制迭代次数以加快速度
